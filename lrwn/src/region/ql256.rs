                ...
                data_rates: [
                    ...
                    (
                        ...
                        DataRate {
                            uplink: true,
                            downlink: true,
                            modulation: DataRateModulation::Fsk(FskDataRate { bitrate: 40000 }),
                        },
                    ),
                    (
                        8,
...
impl Region for Configuration {
    ...
    fn get_downlink_tx_power_eirp(&self, freq: u32) -> isize {
        ...
        //    16
        //}
        if (256000000..258000000).contains(&freq) {
            16
        } else {
            16
        }
    ...
    fn get_defaults(&self) -> Defaults {
        Defaults {
            rx2_frequency: 256700000, //869525000,
            rx2_dr: 7,
...
mod tests {
    ...
    fn config_with_user_channels() -> Configuration {
        ...
        c.add_channel(256700000, 0, 5).unwrap();
        c.add_channel(256900000, 0, 5).unwrap();
        c.add_channel(257100000, 0, 5).unwrap();
        c.add_channel(257300000, 0, 5).unwrap();
        c.add_channel(257500000, 0, 5).unwrap();
        c
    }
    ...
    fn get_rx1_frequency_for_uplink_frequency() {
        ...
        assert_eq!(
            256100000, //868300000,
            c.get_rx1_frequency_for_uplink_frequency(256100000).unwrap()
        );
    }
        ...
        let tests = vec![
            ...
            Test {
                ...
                expected_link_adr_req_payloads: vec![LinkADRReqPayload {
                    ...
                    ch_mask: ChMask::from_slice(&vec![true]).unwrap(),
                }],
            },
        ...
        assert_eq!(
            CFList::Channels(
                CFListChannels::from_slice(&vec![
                    256700000, 256900000, 257100000, 257300000, 257500000,
                ])
                .unwrap()
            ),
